...
public class PnQuanLyNhanVienGUI extends JPanel {
    ...
    private void addControlsNhanVien() {
        ...
        pnTopNV.add(pnTitle);
        pnTopNV.setBackground(Color.WHITE);
        lblTitle.setBackground(Color.WHITE);
        //==========
        ...
        pnHo.add(txtHo);
        pnText.add(pnHo);
        pnHo.setBackground(Color.WHITE);
        ...
        pnTableNhanVien.setBackground(Color.WHITE);
        ...
        pnPhanQuyen.setBackground(Color.WHITE);
        ...
        pnTitlePhanQuyen.setBackground(Color.WHITE);
        ...
        pnCmbQuyen.setBackground(Color.WHITE);
        ...
        pnCheckNhapHang.setBackground(Color.WHITE);
        ...
        pnCheckQLSanPham.setBackground(Color.WHITE);
        ...
        pnCheckQLNhanVien.setBackground(Color.WHITE);
        ...
        pnCheckQLKhachHang.setBackground(Color.WHITE);
