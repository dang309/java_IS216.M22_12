...
//    private JCheckBox ckbRemember;
    ...
    private void addControls() {
        ...
        btnExit = new JLabel(new ImageIcon("image/ManagerUI/btn-close.png"));
...
//        pnMain.add(ckbRemember);
    ...
    private void addEvents() {
        ...
        btnExit.addMouseListener(new MouseListener() {
            ...
            public void mouseEntered(MouseEvent e) {
                btnExit.setIcon(new ImageIcon("image/ManagerUI/btn-close--hover.png"));
            }

            @Override
            public void mouseExited(MouseEvent e) {
                btnExit.setIcon(new ImageIcon("image/ManagerUI/btn-close.png"));
            }
        });
    ...
    private void xuLyDangNhap() {
        ...
        TaiKhoan tk = dangNhapBUS.getTaiKhoanDangNhap(txtUser.getText(),
                new String(txtPassword.getPassword()), true);
        if (tk != null) {
            this.dispose();
            MainLayout gui = new MainLayout();
            gui.showWindow();
        }
    }
