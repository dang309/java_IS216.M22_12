...
public class PnQuanLyBanHangGUI extends JPanel {
    ...
    private void addControlsBanHang() {
        ...
        btnReset = new JButton(new ImageIcon("image/ManagerUI/refresh.png"));
        ...
        JLabel lblTitleGioHang = new JLabel("Giỏ hàng", SwingConstants.CENTER);
        ...
        pnCardTabBanHang.setBackground(Color.WHITE);
        ...
        btnResetHoaDon = new JButton(new ImageIcon("image/ManagerUI/refresh.png"));
        ...
        pnTitleHoaDon.setBackground(Color.WHITE);
        ...
        pnNgayLap.setBackground(Color.WHITE);
        ...
        pnGhiChu.setBackground(Color.WHITE);
...
//        pnCTHoaDonLeft.add(pnSearchDate);
        ...
        btnResetCTHoaDon = new JButton(new ImageIcon("image/ManagerUI/refresh.png"));
        ...
        pnCTHoaDon.setBackground(Color.WHITE);
